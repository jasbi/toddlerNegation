...
The remaining words used in the study (do, you, want, the) are clustered around 50% in terms of production at 27 months, and that proportion in increasing rapidly at that age, as seen in the graph. 

![Production for Yes and No](pictures/yes_no.pdf){ width=50%, height=50% }

![Production for Object Words](pictures/objects.pdf){ width=50%, height=50% }

![Production for Other Words](pictures/other.pdf){ width=50%, height=50% }
