...
1. Whehther the answer to the question is positive or negative
...
Here we want to argue that in the window of 24-30 months toddlers know all these lexical items that's why we do our pilot in this age range.

List of lexical items used: no, yes, want, you, ... [list of our items like car, banana, ...] 
...
* would Block 3 be surprising to babies?

* label-object matching: if the object given is the label mentioned then no surprise, but if it's a different one = surprise (prediction: surprise at Block 2 and 3)
